...
class Flags{
 ...
 public:
  ...
  static Map<BIND::E,uint32> BINDS;
  ...
  static Map<FORMAT::E,DXGI_FORMAT> TEXTURE_FORMATS;

  static Map<FORMAT::E,DXGI_FORMAT> SHADER_RESOURCE_FORMATS;
  
  static Map<FORMAT::E,DXGI_FORMAT> DEPTH_STENCIL_FORMATS;
